 ...
 */
public class CustomInnerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    SubContent[] mDataSet;

    public CustomInnerAdapter(SubContent[] data) {
        mDataSet = data;
    }
    ...
    private static class Product_List_Holder extends RecyclerView.ViewHolder {
        ...
        public Product_List_Holder(View view) {
            super(view);
            imag = (ImageView) view.findViewById(R.id.prod_image);
            labl = (TextView) view.findViewById(R.id.prod_label);
